...
stocker, contrôler et gérer leurs données utilisateurs</p>
  ...
  <section class="service-container">
    ...
    <div class="service-details" id="store">
      <img class="service-detail-icon" src="css/assets/icon/store-icon.svg" alt="">
    ...
    <div class="service-details control-container" id="control">
      <img class="service-detail-icon" src="css/assets/icon/control-icon.svg" alt="">
    ...
    <div class="service-details" id="settings">
      <img class="service-detail-icon"src="css/assets/icon/settings-icon.svg" alt="">
      <div class="service-detail">
    ...
    <div class="informations-container" id="informations">
      <div class="information-container">
        <div class="information-icon">
          <img src="css/assets/icon/security-icon.svg" alt="">
        </div>
     ...
     <div class="information-container">
        <div class="information-icon">
          <img src="css/assets/icon/evolution-icon.svg" alt="">
        </div>
      ...
      <div class="information-container">
        <div class="information-icon">
          <img src="css/assets/icon/reability.svg" alt="">
        </div>
  ...
  <div class="background-element">
    <img src="css/assets/img/square-img.png" alt="">
  </div>
  ...
  <section class="start" id="start">
    <div>
      ...
      <p class="description">Découvrez <span class="strong">RGPD</span> et creez un compte 
        ...
        <div class="contact">
          <button class="button-start">Commencer <img class="chevron" src="css/assets/icon/chevron-white.svg" alt=""></button>
          <a class="link" href="">Contactez l’équipe commerciale<img src="css/assets/icon/chevron-purple.svg" alt=""></a>
        </div>
    </div>
  </section>

  <section class="price" id="price">
    <img class="price-icon" src="css/assets/icon/price-icon.svg" alt="">
    <div>
      ...
      <a class="link" href="">Informations sur les tarifs <img src="css/assets/icon/chevron-purple.svg" alt=""></a>
    </div>
  </section>
